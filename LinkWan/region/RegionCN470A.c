 ...
 * LoRaMAC channels
 */
static ChannelParams_t Channels[CN470A_MAX_NB_CHANNELS] = { CN470A_LC1, CN470A_LC2, CN470A_LC3, CN470A_LC4, CN470A_LC5,                                                            CN470A_LC6, CN470A_LC7, CN470A_LC8 };
...
void RegionCN470AApplyCFList( ApplyCFListParams_t *applyCFList )
{
    ...
    for ( i = 0, chanIdx = CN470A_NUMB_DEFAULT_CHANNELS; i < 15; i += 3, chanIdx++ ) {
        // Channel frequency
...
static uint8_t find_next_available_freqband_index( void )
{
    uint8_t index;
                              ...
                              TimerTime_t *aggregatedTimeOff )
{
    ...
    for ( i = 0; i < CN470A_MAX_NB_CHANNELS; i++ ) {
