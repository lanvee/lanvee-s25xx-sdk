...
//#endif /* _COSMIC_ */
 ...
 INTERRUPT void RTC_IRQHandler(void); /* RTC /CSS_LSE */
 INTERRUPT void EXTIE_F_PVD_IRQHandler(void); /*EXTI PORTE/EXTI PORTF/PVD*/
 INTERRUPT void EXTIB_IRQHandler(void); /* EXTI PORTB / EXTI PORTG */
 INTERRUPT void EXTID_IRQHandler(void); /* EXTI PORTD / EXTI PORTH*/
 ...
 INTERRUPT void LCD_IRQHandler(void); /* LCD /AES */
 ...
 INTERRUPT void TIM2_UPD_OVF_TRG_BRK_IRQHandler(void); /* TIM2 UPD/OVF/TRG/BRK / USART2 TX */
 INTERRUPT void TIM2_CAP_IRQHandler(void); /* TIM2 CAP / USART2 RX */
 INTERRUPT void TIM3_UPD_OVF_TRG_BRK_IRQHandler(void); /* TIM3 UPD/OVF/TRG/BRK /USART3 TX*/
 INTERRUPT void TIM3_CAP_IRQHandler(void); /* TIM3 CAP/ USART3 RX */
 INTERRUPT void TIM1_UPD_OVF_TRG_COM_IRQHandler(void);/* TIM1 UPD/OVF/TRG/COM */
 INTERRUPT void TIM1_CAP_IRQHandler(void);/* TIM1 CAP*/
 ...
 INTERRUPT void I2C1_IRQHandler(void); /* I2C1 / SPI2 */
#endif /* _RAISONANCE_ */
